...
function Renderer( id )
{
	...
	playerTexture.image.src = "resource_packs/default/textures/entity/player.png";
	...
	terrainTexture.image.src = "resource_packs/default/textures/terrain.png";
...
Renderer.prototype.draw = function()
{
	...
	for ( var p in world.players )
	{
		...
		mat4.translate( this.modelMatrix, [ -0.05, 0, 0 ] );
		...
		// right arm poa
		mat4.translate( this.modelMatrix, [ 0.10, 0, 0 ] );
...
Renderer.prototype.loadPlayerBodyModel = function()
{
	...
	var vertices = [
		...
		// Top
		-0.25, -0.125, 1.45, 20/64, 16/32, 1, 1, 1, 1,
		0.25, -0.125, 1.45, 28/64, 16/32, 1, 1, 1, 1,
		0.25, 0.125, 1.45, 28/64, 20/32, 1, 1, 1, 1,
		0.25, 0.125, 1.45, 28/64, 20/32, 1, 1, 1, 1,
		-0.25, 0.125, 1.45, 20/64, 20/32, 1, 1, 1, 1,
		-0.25, -0.125, 1.45, 20/64, 16/32, 1, 1, 1, 1,

		// Bottom
		-0.25, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,
		-0.25, 0.125, 0.73, 28/64, 20/32, 1, 1, 1, 1,
		0.25, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		0.25, 0.125, 0.73, 36/64, 20/32, 1, 1, 1, 1,
		0.25, -0.125, 0.73, 36/64, 16/32, 1, 1, 1, 1,
		-0.25, -0.125, 0.73, 28/64, 16/32, 1, 1, 1, 1,

		// Front
		-0.25, -0.125, 1.45, 20/64, 20/32, 1, 1, 1, 1,
		-0.25, -0.125, 0.73, 20/64, 32/32, 1, 1, 1, 1,
		0.25, -0.125, 0.73, 28/64, 32/32, 1, 1, 1, 1,
		0.25, -0.125, 0.73, 28/64, 32/32, 1, 1, 1, 1,
		0.25, -0.125, 1.45, 28/64, 20/32, 1, 1, 1, 1,
		-0.25, -0.125, 1.45, 20/64, 20/32, 1, 1, 1, 1,

		// Rear
		-0.25, 0.125, 1.45, 40/64, 20/32, 1, 1, 1, 1,
		0.25, 0.125, 1.45, 32/64, 20/32, 1, 1, 1, 1,
		0.25, 0.125, 0.73, 32/64, 32/32, 1, 1, 1, 1,
		0.25, 0.125, 0.73, 32/64, 32/32, 1, 1, 1, 1,
		-0.25, 0.125, 0.73, 40/64, 32/32, 1, 1, 1, 1,
		-0.25, 0.125, 1.45, 40/64, 20/32, 1, 1, 1, 1,

		// Right
		-0.25, -0.125, 1.45, 16/64, 20/32, 1, 1, 1, 1,
		-0.25, 0.125, 1.45, 20/64, 20/32, 1, 1, 1, 1,
		-0.25, 0.125, 0.73, 20/64, 32/32, 1, 1, 1, 1,
		-0.25, 0.125, 0.73, 20/64, 32/32, 1, 1, 1, 1,
		-0.25, -0.125, 0.73, 16/64, 32/32, 1, 1, 1, 1,
		-0.25, -0.125, 1.45, 16/64, 20/32, 1, 1, 1, 1,
	...
	var vertices = [
		...
		// Bottom
		0.01, -0.125, -0.67,  8/64, 16/32, 1, 1, 1, 1,
		0.01,  0.125, -0.67,  8/64, 20/32, 1, 1, 1, 1,
		0.3,   0.125, -0.67, 12/64, 20/32, 1, 1, 1, 1,
		0.3,   0.125, -0.67, 12/64, 20/32, 1, 1, 1, 1,
		0.3,  -0.125, -0.67, 12/64, 16/32, 1, 1, 1, 1,
		0.01, -0.125, -0.67,  8/64, 16/32, 1, 1, 1, 1,

		// Front
		0.01, -0.125,     0, 4/64, 20/32, 1, 1, 1, 1,
		0.01, -0.125, -0.67, 4/64, 32/32, 1, 1, 1, 1,
		0.3,  -0.125, -0.67, 8/64, 32/32, 1, 1, 1, 1,
		0.3,  -0.125, -0.67, 8/64, 32/32, 1, 1, 1, 1,
		0.3,  -0.125,     0, 8/64, 20/32, 1, 1, 1, 1,
		0.01, -0.125,     0, 4/64, 20/32, 1, 1, 1, 1,
		...
		0.3,  0.125, -0.67, 16/64, 32/32, 1, 1, 1, 1,
		0.3,  0.125, -0.67, 16/64, 32/32, 1, 1, 1, 1,
		0.01, 0.125, -0.67, 12/64, 32/32, 1, 1, 1, 1,
		0.01, 0.125,     0, 12/64, 20/32, 1, 1, 1, 1,
		...
		0.01,  0.125, -0.67, 12/64, 32/32, 1, 1, 1, 1,
		0.01,  0.125, -0.67, 12/64, 32/32, 1, 1, 1, 1,
		0.01, -0.125, -0.67,  8/64, 32/32, 1, 1, 1, 1,
		0.01, -0.125,     0,  8/64, 20/32, 1, 1, 1, 1,

		// Left
		0.3, -0.125,     0, 4/64, 20/32, 1, 1, 1, 1,
		0.3, -0.125, -0.67, 4/64, 32/32, 1, 1, 1, 1,
		0.3,  0.125, -0.67, 0/64, 32/32, 1, 1, 1, 1,
		0.3,  0.125, -0.67, 0/64, 32/32, 1, 1, 1, 1,
	...
	var vertices = [
		...
		// Bottom
		-0.3,  -0.125, -0.67,  8/64, 16/32, 1, 1, 1, 1,
		-0.3,   0.125, -0.67,  8/64, 20/32, 1, 1, 1, 1,
		-0.01,  0.125, -0.67, 12/64, 20/32, 1, 1, 1, 1,
		-0.01,  0.125, -0.67, 12/64, 20/32, 1, 1, 1, 1,
		-0.01, -0.125, -0.67, 12/64, 16/32, 1, 1, 1, 1,
		-0.3,  -0.125, -0.67,  8/64, 16/32, 1, 1, 1, 1,
