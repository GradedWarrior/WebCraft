...
function func_addStyle(style) {
	...
	head.innerHTML = head.innerHTML + '<link rel="stylesheet" type="text/css" href="' + style + '">';

}

function func_addScript(script) {
		var head = document.getElementByTagName("head");
	head.innerHTML = head.innerHTML + '<script src="' + script + '" type="text/javascript"></script>';
}
